...
import com.example.algamoney.api.resource.filter.PessoaFilter;
...
public class PessoaRepositoryImpl implements PessoaRepositoryQuery {
	...
	private void adicionarRestricoesDePaginacao(TypedQuery<?> query, Pageable pageable) {
		...
		int primeiroResgitroDaPagina = paginaAtual * totalRegistroPorPagina;

		query.setFirstResult(primeiroResgitroDaPagina);
